package com.liferay.grow.gamification.badges.list.constants;

/**
 * @author vili
 */
public class UserBadgeListPortletKeys {
	...
	public static final String UserBadgeList = "userbadgelist";
