...
package com.liferay.micro.maintainance.candidate.service.base;
...
/**
 * Provides the base implementation for the candidate entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.micro.maintainance.candidate.service.impl.CandidateEntryLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class CandidateEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CandidateEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.micro.maintainance.candidate.service.CandidateEntryLocalServiceUtil} to access the candidate entry local service.
	 */
	...
	public CandidateEntry addCandidateEntry(CandidateEntry candidateEntry) {
		...
		return candidateEntryPersistence.update(candidateEntry);
	}
	...
	public CandidateEntry deleteCandidateEntry(CandidateEntry candidateEntry) {
		return candidateEntryPersistence.remove(candidateEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CandidateEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return candidateEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return candidateEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	 ...
	 */
	@Override
	public CandidateEntry fetchCandidateEntryByUuidAndGroupId(String uuid,
		long groupId) {
		return candidateEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(candidateEntryLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(candidateEntryLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<CandidateEntry>() {
				@Override
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(CandidateEntry.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return candidateEntryLocalService.deleteCandidateEntry((CandidateEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return candidateEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CandidateEntry> getCandidateEntriesByUuidAndCompanyId(
		...
		return candidateEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<CandidateEntry> getCandidateEntriesByUuidAndCompanyId(
		...
		return candidateEntryPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public CandidateEntry getCandidateEntryByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return candidateEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<CandidateEntry> getCandidateEntries(int start, int end) {
		return candidateEntryPersistence.findAll(start, end);
	}
	...
	public int getCandidateEntriesCount() {
		return candidateEntryPersistence.countAll();
	}
	...
	/**
	 * Returns the candidate entry local service.
	 *
	 * @return the candidate entry local service
	 */
	public CandidateEntryLocalService getCandidateEntryLocalService() {
		return candidateEntryLocalService;
	}

	/**
	 * Sets the candidate entry local service.
	 *
	 * @param candidateEntryLocalService the candidate entry local service
	 */
	public void setCandidateEntryLocalService(
		CandidateEntryLocalService candidateEntryLocalService) {
		this.candidateEntryLocalService = candidateEntryLocalService;
	}

	/**
	 * Returns the candidate entry persistence.
	 *
	 * @return the candidate entry persistence
	 */
	public CandidateEntryPersistence getCandidateEntryPersistence() {
		return candidateEntryPersistence;
	}

	/**
	 * Sets the candidate entry persistence.
	 *
	 * @param candidateEntryPersistence the candidate entry persistence
	 */
	public void setCandidateEntryPersistence(
		CandidateEntryPersistence candidateEntryPersistence) {
		this.candidateEntryPersistence = candidateEntryPersistence;
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.micro.maintainance.candidate.model.CandidateEntry",
			candidateEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CandidateEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = candidateEntryPersistence.getDataSource();
	...
	@BeanReference(type = CandidateEntryLocalService.class)
	protected CandidateEntryLocalService candidateEntryLocalService;
	@BeanReference(type = CandidateEntryPersistence.class)
	protected CandidateEntryPersistence candidateEntryPersistence;
