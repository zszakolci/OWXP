...
/**
 * Provides the local service interface for TaskEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TaskEntryLocalServiceUtil
...
public interface TaskEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaskEntryLocalServiceUtil} to access the task entry local service. Add custom service methods to {@link com.liferay.micro.maintainance.task.service.impl.TaskEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
