...
public class DecisionEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newDecisionEntry.setAnalysisId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingDecisionEntry.getAnalysisId(),
			newDecisionEntry.getAnalysisId());
	...
	@Test
	public void testCountByD_A() throws Exception {
		_persistence.countByD_A(RandomTestUtil.nextLong(),
			RandomTestUtil.nextLong());

		_persistence.countByD_A(0L, 0L);
	}
	...
	@Test
	public void testCountByD_A_H() throws Exception {
		_persistence.countByD_A_H(RandomTestUtil.nextLong(),
			RandomTestUtil.nextLong(), RandomTestUtil.randomBoolean());

		_persistence.countByD_A_H(0L, 0L, RandomTestUtil.randomBoolean());
	}
	...
	@Test
	public void testCountByC_NotH() throws Exception {
		_persistence.countByC_NotH(RandomTestUtil.nextLong(),
			RandomTestUtil.randomBoolean());

		_persistence.countByC_NotH(0L, RandomTestUtil.randomBoolean());
	}
	...
	protected OrderByComparator<DecisionEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Decision_DecisionEntry",
			...
			"analysisId", true, "outcome", true, "handled", true);
	}
	...
	protected DecisionEntry addDecisionEntry() throws Exception {
		...
		decisionEntry.setAnalysisId(RandomTestUtil.nextLong());
