...
public class DecisionEntryModelImpl extends BaseModelImpl<DecisionEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table Decision_DecisionEntry (uuid_ VARCHAR(75) null,decisionId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,analysisId LONG,outcome VARCHAR(75) null,handled BOOLEAN)";
	...
	public static final long DECISIONID_COLUMN_BITMASK = 4L;
	public static final long HANDLED_COLUMN_BITMASK = 8L;
	...
	public Object clone() {
		...
		decisionEntryImpl.setAnalysisId(getAnalysisId());
	...
	public void resetOriginalValues() {
		...
		decisionEntryModelImpl._originalAnalysisId = decisionEntryModelImpl._analysisId;

		decisionEntryModelImpl._setOriginalAnalysisId = false;
	...
	public CacheModel<DecisionEntry> toCacheModel() {
		...
		decisionEntryCacheModel.analysisId = getAnalysisId();
