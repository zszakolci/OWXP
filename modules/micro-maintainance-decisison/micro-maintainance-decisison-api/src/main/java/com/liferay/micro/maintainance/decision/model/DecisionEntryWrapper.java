...
public class DecisionEntryWrapper implements DecisionEntry,
	...
	*/
	...
	/**
	* Returns the analysis ID of this decision entry.
	*
	* @return the analysis ID of this decision entry
	*/
	@Override
	public long getAnalysisId() {
		return _decisionEntry.getAnalysisId();
	}
	...
	*/
	...
	/**
	* Sets the analysis ID of this decision entry.
	*
	* @param analysisId the analysis ID of this decision entry
	*/
	@Override
	public void setAnalysisId(long analysisId) {
		_decisionEntry.setAnalysisId(analysisId);
	}
