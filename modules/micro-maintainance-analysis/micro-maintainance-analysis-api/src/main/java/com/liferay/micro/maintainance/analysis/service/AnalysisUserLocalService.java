...
/**
 * Provides the local service interface for AnalysisUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AnalysisUserLocalServiceUtil
...
public interface AnalysisUserLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnalysisUserLocalServiceUtil} to access the analysis user local service. Add custom service methods to {@link com.liferay.micro.maintainance.analysis.service.impl.AnalysisUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
