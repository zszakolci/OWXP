...
/**
 * Provides the local service utility for AnalysisUser. This utility wraps
 * {@link com.liferay.micro.maintainance.analysis.service.impl.AnalysisUserLocalServiceImpl} and is the
 ...
 * @see com.liferay.micro.maintainance.analysis.service.base.AnalysisUserLocalServiceBaseImpl
 * @see com.liferay.micro.maintainance.analysis.service.impl.AnalysisUserLocalServiceImpl
 * @generated
 */
@ProviderType
public class AnalysisUserLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.micro.maintainance.analysis.service.impl.AnalysisUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser addAnalysisUser(
		...
		return getService().addAnalysisUser(analysisUser);
	}
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser createAnalysisUser(
		long analysisUserId) {
		return getService().createAnalysisUser(analysisUserId);
	}
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser deleteAnalysisUser(
		com.liferay.micro.maintainance.analysis.model.AnalysisUser analysisUser) {
		return getService().deleteAnalysisUser(analysisUser);
	}
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser deleteAnalysisUser(
		...
		return getService().deleteAnalysisUser(analysisUserId);
	}

	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser fetchAnalysisUser(
		long analysisUserId) {
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser getAnalysisUser(
		long analysisUserId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getAnalysisUser(analysisUserId);
	}
	...
	*/
	public static com.liferay.micro.maintainance.analysis.model.AnalysisUser updateAnalysisUser(
		com.liferay.micro.maintainance.analysis.model.AnalysisUser analysisUser) {
		return getService().updateAnalysisUser(analysisUser);
	}
	...
	*/
	public static int getAnalysisUsersCount() {
		return getService().getAnalysisUsersCount();
	}
	...
	*/
	public static java.util.List<com.liferay.micro.maintainance.analysis.model.AnalysisUser> getAnalysisUsers(
		int start, int end) {
		return getService().getAnalysisUsers(start, end);
	}
	...
	*/
	...
	public static AnalysisUserLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<AnalysisUserLocalService, AnalysisUserLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AnalysisUserLocalService.class);
}